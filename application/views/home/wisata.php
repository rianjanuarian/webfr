		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title">Daftar wisata</h2>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price">Rp. <?php echo $gbr->harga_tiket ?>,-</div>
									<div class="">
										<i></i>
										<i></i>
										<i></i>
									...
									<p class="offers_text"><pre>Alamat : <?php echo $gbr->alamat_wisata?></pre></p>
